...
export const houndAbilities: Ability[] = [
    ...
    {
        name: "Custodian",
        description: "Gain 'Mend' skill. If you are in a populated location you can always find someone willing to take you in and show great hospitality.",
        type: "minor",
    ...
    {
        name: "Liquid Courage",
        description: "Gain +1 'Mind' protection. When you go drinking to remove 'Mind' stress or fallout, treat the spent resource as one dice higher.",
        type: "minor",

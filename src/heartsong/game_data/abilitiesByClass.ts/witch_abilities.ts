...
export const witchAbilities: Ability[] = [
    ...
    {
        name: "The Old Blood",
        description: "Gain 'Discern' skill. When you observe someone for a few seconds, you can read their aura and discern their surface-level emotions.",
        type: "minor",
    ...
    {
        name: "Ramblewyrd",
        description: "Gain 'Cursed' domain. Once per session, when you are in a 'Cursed' area, remove D6 stress from resistances of your choice.",
        type: "minor",
    ...
    {
        name: "Sacred Object",
        description: "Once per session, when you assume your true form, downgrade one 'Blood' fallout result you are suffering from by one step.",
        type: "minor",
        staticBonuses: noBonuses(),
        parentName: "Great and Terrible",
        pickFrom: pickFrom({}),

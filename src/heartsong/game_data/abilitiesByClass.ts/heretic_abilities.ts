...
export const hereticAbilities: Ability[] = [
    {
        ...
        description:
            "Gain 'Desolate' domain. When suffering from ongoing 'Supplies' fallout, gai 'Trusty' on your rolls to inflict stress on delves.",
        type: "minor",
    ...
    },
    {
        ...
        description:
            "Gain 'Compel' skill. When you invoke your holy texts in conversation with another member of your faith, roll with 'Mastery'.",
        type: "minor",
    ...
    //  Oath of Sagacity
    {
        ...
        description:
            "You know the name of the Goddess, and it functions as a 'Kill' D6, 'Spread', 'Debilitating', 'Maddening', 'One-Shot' weapon.",
        type: "major",
        staticBonuses: noBonuses(),
    },
    {
